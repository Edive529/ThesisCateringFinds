              ...
              <tbody>
                ...
                $userid = $_SESSION['userid'];
                  ...
                  while($row=$select->fetch(PDO::FETCH_OBJ)){
                    ...
                    <td>
                    <a href = "editmenu.php?id='.$row->foodid.'"  class="btn btn-info" role = "button" ><span class = "fas fa-edit" style = "color:#ffffff" data-toggle="tooltip" title="edit"></span></a>
                    </td>
                    <td>
