...
<div class="container">
	...
	foreach($itemDetails as $item){
		$average = $rating->getRatingAverage($item["foodid"]);
	?>
	<div class="row">
		<div class="col-sm-2" style="width:150px">
			<img class="product_image" src="img/car/<?php echo $item["image"]; ?>" style="width:100px;height:200px;padding-top:10px;">
		</div>
		<div class="col-sm-4">
		<h4 style="margin-top:10px;"><?php echo $item["food"]; ?></h4>
