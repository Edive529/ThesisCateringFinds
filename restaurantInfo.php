   ...
   <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="container py-5" > 
          <div class="position-relative d-flex"> 
              <div class="top-0 start-0 w-100 h-100 d-flex" >
                   
                    
                      <div class="row d-flex">
                      <div class="col-4 col-lg-6">
                            <img class="img-fluid w-auto h-auto" src="img/car/avd.jpg"alt="">
                        </div>
                          <div class="col-4 col-lg-4">
                              <h3 class="display-6 text-black animated slideInDown  ">Jack's Kainan</h3>
                              <p></p>
                              <p class="fs-5 fw-medium text-black "> ratings</p>
...
<!-- food Category Start --> 
<div class="container p-4 mp2" style="background-color:#f8f9fa;"> 
